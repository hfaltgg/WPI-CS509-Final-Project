...
public class SearchThreeAdapter extends BaseAdapter{
    ...
    public SearchThreeAdapter(List<Flights> mDataset, SeatClass mSeatClass, TripType mTripType, StopOvers mStopOvers, Integer mNumber) {
    ...
    public void setDateset(List<Flights> mDataset) {
        this.mDataset = mDataset;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.mDepAirportCode.setText(mDataset.get(position).get(0).getmDepAirportCode() + "");
        holder.mArrAirportCode.setText(mDataset.get(position).get(2).getmArrAirportCode() + "");
        DateFormat dateFormat = new SimpleDateFormat("MMM/dd/yyyy");
        holder.mDepTime.setText(dateFormat.format(mDataset.get(position).get(0).getmDepTime()) + "");
        holder.mArrTime.setText(dateFormat.format(mDataset.get(position).get(2).getmArrTime()) + "");
        holder.mFlightTime.setText((mDataset.get(position).get(0).getmFlightTime() + mDataset.get(position).get(1).getmFlightTime()
                + mDataset.get(position).get(2).getmFlightTime()) + " min");

        DecimalFormat df2 = new DecimalFormat(".##");
        if (mSeatClass == SeatClass.COACHCLASS) {
            holder.mPrice.setText("$ " + df2.format(mDataset.get(position).get(0).getmCoachPrice() * mNumber
                    + mDataset.get(position).get(1).getmCoachPrice() * mNumber + mDataset.get(position).get(2).getmCoachPrice() * mNumber));
        } else {
            holder.mPrice.setText("$ " + df2.format(mDataset.get(position).get(0).getmFirstPrice() * mNumber
                    + mDataset.get(position).get(1).getmFirstPrice() * mNumber + mDataset.get(position).get(2).getmFirstPrice() * mNumber));
        }
